...
class RevSliderSliderExport extends RevSliderSlider {
	...
	public $use_dummy = false;
	public $with_local_links = false;
	...
	public function serialize_export_data(){
		...
		if ( $this->use_dummy && ! $this->with_local_links ) {
			$upload_dir = wp_upload_dir();

			$data = vamtam_recursive_preg_replace( '#^uploads#', $upload_dir['baseurl'], $data );
		}
