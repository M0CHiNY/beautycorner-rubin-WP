...
<div class="cart-wrapper-bc">
	<form class="woocommerce-cart-form cart-form--bc" action="<?php echo esc_url(wc_get_cart_url()); ?>"
		method="post">
		<?php do_action('woocommerce_before_cart_table'); ?>
		<table
			class="shop_table shop_table_responsive cart woocommerce-cart-form__contents wc-block-cart-items wp-block-woocommerce-cart-line-items-block bc-cart--item"
			cellspacing="0">
			<thead>
				<tr>
				...
				foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
					...
					if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) {
						...
						<tr
							...
							<td class="product-subtotal product-subtotal--bc" data-title="<?php esc_attr_e('Subtotal', 'woocommerce'); ?>">
								<?php
	...
	<div class="cart-collaterals cart-collaterals--bc">
		<?php
		/**
