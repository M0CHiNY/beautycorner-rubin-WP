...
<div id="oceanwp-off-canvas-sidebar-wrap">
	...
	<div class="oceanwp-off-canvas-sidebar">
		...
		<?php
		if (is_active_sidebar('owp_off_canvas_sidebar')) {
			dynamic_sidebar('owp_off_canvas_sidebar');
		}
		...
		if (true === get_theme_mod('ocean_woo_off_canvas_close_button', false)) {
			...
			<button type="button" class="oceanwp-off-canvas-close"
				aria-label="<?php echo esc_attr__('Close off canvas panel', 'oceanwp'); ?>">

				<svg width="14" height="14" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
					viewBox="0 0 512 512" xml:space="preserve" role="img" aria-hidden="true" focusable="false">
